...
- focus and selection methods on the model or item handles, including
  `scrollToPath(...)` when you want to reveal a path without moving DOM focus
  and optional model focus changes
