...
Custom themes for [Zed](https://zed.dev) from the team that built
[Diffs.com](https://diffs.com), [The Pierre Computer
Company]{https://pierre.computer}.
...
Search for "Pierre" in Zed's extension manager (`Cmd+Shift+X` or
`Ctrl+Shift+X`).
