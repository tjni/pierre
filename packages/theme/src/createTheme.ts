...
export function createTheme({
  ...
  return {
    ...
    colors: {
      ...
      'diffEditor.deletedTextBackground': alpha(
        c.states.danger,
        kind === 'dark' ? 0.1 : 0.2
      ),
      ...
      // Lists
      'list.activeSelectionBackground': alpha(
        c.accent.subtle,
        kind === 'dark' ? 0.6 : 0.8
      ),
      ...
      'button.hoverBackground': mix(
        c.accent.primary,
        c.accent.contrastOnAccent,
        0.1
      ),
